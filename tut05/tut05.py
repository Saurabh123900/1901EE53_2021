...
def generate_marksheet():
    ...
    with open('grades.csv','r') as file:                                             #File opening
        f_in = csv.reader(file)                                                      #File Reading
...
generate_marksheet()                                            #Calling generate_marksheet function